                ...
                <table class="poll">
                    ...
                    @foreach ($poll->questions as $question)
                        <tr>
                            <td>
                                <div class="progress">
                                    <div class="progress-bar2 color1" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 90%">
                                        {{$question->title}}
                                </div>
                            </td>
                            <td class="chbox">
                                <input id="opt1" type="radio" name="quest[]" value="{{$question->id}}">
